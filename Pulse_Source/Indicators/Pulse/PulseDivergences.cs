...
namespace NinjaTrader.NinjaScript.Indicators.Pulse
{
	public class PulseDivergences : Indicator
	{
		...
		private Brush bullishDivergenceBrush = new System.Windows.Media.SolidColorBrush(System.Windows.Media.Color.FromRgb(107, 111, 204));

		private Brush bearishDivergenceBrush = new System.Windows.Media.SolidColorBrush(System.Windows.Media.Color.FromRgb(74, 74, 74));
		...
		protected override void OnStateChange()
		{
			if (State == State.SetDefaults)
			{
				...
				bullishDivergenceBrush = new System.Windows.Media.SolidColorBrush(System.Windows.Media.Color.FromRgb(107, 111, 204));
				bearishDivergenceBrush = new System.Windows.Media.SolidColorBrush(System.Windows.Media.Color.FromRgb(74, 74, 74));
			}
		...
		private void DrawBullishDivergence()
		{
			...
			Draw.Text(this, tag, isAutoScale: false, "★", 0, y, 0, bullishDivergenceBrush, GetSymbolFont(), TextAlignment.Center, Brushes.Transparent, Brushes.Transparent, 0);
		}
		...
		private void DrawBearishDivergence()
		{
			...
			Draw.Text(this, tag, isAutoScale: false, "★", 0, y, 0, bearishDivergenceBrush, GetSymbolFont(), TextAlignment.Center, Brushes.Transparent, Brushes.Transparent, 0);
		}
