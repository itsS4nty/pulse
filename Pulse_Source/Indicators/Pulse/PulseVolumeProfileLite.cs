	...
	public class PulseVolumeProfileLite : Indicator
	{
		...
		protected override void OnStateChange()
		{
			if (State == State.SetDefaults)
			{
				...
				PriceHistogramVAHColor = new System.Windows.Media.SolidColorBrush(System.Windows.Media.Color.FromRgb(74, 74, 74));
				PriceHistogramVAColor = new System.Windows.Media.SolidColorBrush(System.Windows.Media.Color.FromRgb(74, 74, 74));
				PriceHistogramVALColor = new System.Windows.Media.SolidColorBrush(System.Windows.Media.Color.FromRgb(74, 74, 74));
				PriceHistogramBorderColor = new System.Windows.Media.SolidColorBrush(System.Windows.Media.Color.FromRgb(74, 74, 74));
				...
				VolumeHistogramBorderColor = new System.Windows.Media.SolidColorBrush(System.Windows.Media.Color.FromRgb(74, 74, 74));
				VolumeHistogramStroke = new Stroke(new System.Windows.Media.SolidColorBrush(System.Windows.Media.Color.FromRgb(184, 188, 198)), DashStyleHelper.Solid, 34f, 30);
				Print("Pulse Volume Profile Lite: Professional Market Profile initialized - Pulse Suite");
				return;
			}
			if (State == State.Configure)
			{
				...
				if (!flag && !flag2)
				{
					Print($"Pulse Volume Profile Lite: Adding 1-minute series for {Bars.BarsPeriod.BarsPeriodType} {Bars.BarsPeriod.Value} chart");
					AddDataSeries(BarsPeriodType.Minute, 1);
				}
				else if (flag)
				{
					Print("Pulse Volume Profile Lite: Already on 1-minute chart, no additional series needed");
				}
				else if (flag2)
				{
					Print($"Pulse Volume Profile Lite: Volume chart detected ({Bars.BarsPeriod.Value} volume), using primary series directly");
				}
				return;
			}
			...
			{
				if (ChartControl != null && ChartBars.Properties.ChartStyle.DownBrush == Brushes.Transparent)
				{
		...
		protected override void OnBarUpdate()
		{
			...
			{
				Print($"Pulse Volume Profile Lite ERROR: {ex.Message} at Bar={CurrentBar}, BarsInProgress={BarsInProgress}");
			}
		}
